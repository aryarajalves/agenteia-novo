...
# Regra de Atualização do docs/BUSINESS_RULES.md
...
2. **Adicionar ao docs/BUSINESS_RULES.md:** Inclua a pergunta na seção mais relevante do arquivo, no formato:
```markdown
...
```
> 📋 **Perguntas novas adicionadas ao docs/BUSINESS_RULES.md:** <lista resumida das perguntas>
```
